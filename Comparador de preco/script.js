...
[x] Get the data from the Input, when the button is clicked. 
[x] Go to the server and bring the products. 
[] Place the Products on the screen. 
...
// TODO: Implement this function to update the price chart with the product's price
